package day27exceptions.day31maps;
...
public class HashMap01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("remove(\"Ajda\", 76); : "+result);
        ...
        Integer result2 = studentAges.getOrDefault("Bradi", 120);
        System.out.println("getOrDefault : "+result2);//12---120

        //Value null ise ekleme yapar, value null degilse ekleme yapmaz.
        Integer result3 = studentAges.putIfAbsent("Brad", 100);
        System.out.println("putIfAbsent "+result3);//12
        ...
        System.out.println("replace(\"Acun Ilicali\", 49) : "+studentAges);
